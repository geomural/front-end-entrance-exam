...
Проект опубликован по ссылке: https://geomural.github.io/front-end-entrance-exam/

- Реализована возможность редактирования текстовых элементов резюме. 
- Изменения сохраняются при перезагрузке страницы.
- Для скачивания резюме в формате PDF необходимо нажать кнопку "Скачать" внизу страницы.
- Изменения элементов резюме анимированы с помощью CSS-анимаций.
- Добавлен эффект Ripple при взаимодействии с элементами страницы (кликах на элементы).
- Добавлена оптимизация и сохранение введенных данных в случае обновления страницы.

Для запуска достаточно скачать репозиторий и открыть в браузере файл index.html.
